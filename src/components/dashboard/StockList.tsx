        ...
        <div className="py-6">
            <div className="mb-8">
                ...
                <div className="flex gap-4 overflow-x-auto pb-4 scrollbar-hide -mx-4 px-4 md:mx-0 md:px-0 md:grid md:grid-cols-3 md:gap-6 md:overflow-visible">
                    <StockCard symbol="AAPL" name="Apple Inc" price="Rp 1.499.000" logo="" color="bg-black" />
                    <StockCard symbol="TSLA" name="Tesla Inc" price="Rp 3.499.000" logo="" color="bg-red-500" />
                    <StockCard symbol="NVDA" name="Nvidia Corp" price="Rp 7.499.000" logo="" color="bg-green-500" />
                </div>
            </div>
            ...
            <div>
                ...
                <div className="flex flex-col gap-3 md:grid md:grid-cols-2 md:gap-4">
                    <StockListItem symbol="AAPL" name="Apple Inc" price="Rp 150.000" logo="" color="bg-black" />
                    <StockListItem symbol="TSLA" name="Tesla Inc" price="Rp 150.000" logo="" color="bg-red-500" />
                    <StockListItem symbol="NVDA" name="Nvidia Corp" price="Rp 150.000" logo="" color="bg-green-500" />
                    <StockListItem symbol="MSFT" name="Microsoft" price="Rp 150.000" logo="" color="bg-blue-500" />
                </div>
            </div>
        </div>
    );
